...
scalar = 0.5 #ratio for the steering angle

# speed - LateralPIDParam
OPTIMIZED_LATERAL_PID_VALUES = {
    60:  PIDParam(K_P=0.5*scalar, K_D=0.5*scalar, K_I=0.5*scalar),
    100: PIDParam(K_P=0.2*scalar, K_D=0.2*scalar, K_I=0.5*scalar),
    150: PIDParam(K_P=0.01*scalar, K_D=0.075*scalar, K_I=0.7*scalar),
}
